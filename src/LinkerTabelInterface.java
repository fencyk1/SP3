 ...
 * Name, type, and location, where name is the program or variable name, type is program, ent, ext, etc,
...
public interface LinkerTabelInterface {
	...
	/**This method adds a symbole to the symbol table
	 * 
	 * @param name = variable name
	 * @param type = type of variable: program, ent, or ext
